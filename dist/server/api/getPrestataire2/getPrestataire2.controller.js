...
//-----------------------------------//
	var mySqlClient = mysql.createConnection({
	  ...
	  socketPath : databaseMySQL.socketPath
        ...
        var query = 'SELECT distinct SPLIT_STR(prestataire_libel,"|", 2) as "Prestataire_Libel" FROM fdj.table_prestataires where Code_prestataire != 99 order by code_prestataire ASC;';
	console.log("---------");
	console.log("QUERY");
	console.log(query);
	console.log("----------");
